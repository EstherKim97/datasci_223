...
**NOTE**: there are two reasons you use this
1.
2.
...
**Note**: python for data analytics, python data scienc ehandbook vanderplus - helpful reference cards
...
- What does an AUC of 0.5 mean? => same flip of a coin
- What about 1.0? 
- Why might AUC not be the best metric for every health data problem? => helps to choose the threshold for the prediction, but does not take background into account.
...
**Note:** due to computational reason, the neural network uses ReLu instead of logistic regression.
